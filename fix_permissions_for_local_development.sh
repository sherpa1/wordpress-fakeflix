...
sudo chown -R $WWW_DATA_UID:$USER ./wordpress_data/wp-content
sudo find ./wordpress_data/wp-content -type d -exec chmod 775 {} \;
sudo find ./wordpress_data/wp-content -type f -exec chmod 664 {} \;
